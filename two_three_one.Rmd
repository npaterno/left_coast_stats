...
# R Package 
All materials needed for lab days can be found in the [Stat231](https://www.github.com/npaterno/Stat231) R package. Students can install the package by running the code below in the console of RStudio (requires the `devtools` package). As with R and RStudio, there will be dedicated time in class for this activity. 
