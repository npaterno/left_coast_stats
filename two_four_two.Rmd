...
# Course Goals
*(Largely adapted from my collegue [Dr. Justice](https://sites.google.com/plu.edu/njustice/courses/stat-242?authuser=0))*
...
We will have a total of *n* computer labs using R and RStudio. There will be dedicated class time to installing the software or setting up a cloud account. Those who feel comfortable doing so can download [R](https://cran.r-project.org) and [RStudio](https://www.rstudio.com/download) prior to the start of class.
...
Each lesson can be found as a vignette in the help file or as a [slidedeck](https://npaterno.github.io/left_coast_stats/slides). The corresponding assignments are available as RMarkdown templates.
